...
export const sendRegisterEmail = async (toEmail: string, username: string) => {
    try {
        const mailOptions = {
            from: `"E‑Shift Logistics" <${process.env.EMAIL_USER}>`,
            to: toEmail,
            subject: "Welcome to E‑Shift Logistics!",
            text: `Hello ${username},\n\nThank you for registering with E‑Shift Logistics. You can now manage transport jobs, assign vehicles, and explore our logistics platform.\n\nLogin here: https://your-eshift-platform.com/login\n\nIf this wasn't you, contact us immediately.\n\nBest,\nE‑Shift Team`,
            html: `
